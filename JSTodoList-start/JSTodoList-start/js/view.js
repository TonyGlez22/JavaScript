...
export default class View {
    constructor() {
        this.model = null;
        this.table = document.getElementById('table').getElementsByTagName('tbody')[0];
    ...
    createRow(todo) {
        ...
        row.innerHTML = `
            ...
            <td style="background-color:${priorityColor}">${todo.priority}</td>
    ...
    getPriorityColor(priority) {
        switch (priority) {
            case '3': return 'red';   // Alta prioridad
            case '2': return 'yellow'; // Media prioridad
            case '1': return 'green';  // Baja prioridad
